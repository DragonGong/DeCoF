...
# python $run_dir/model.py $to_pred_dir $submit_path
# python $run_dir/model_parallel.py $to_pred_dir $submit_path
python $run_dir/model_parallel_batch.py $to_pred_dir $submit_path
